class UserContact < ActiveRecord::Base
  ...
  validates :first, :last, :occupation, :street_number, :street, :city, :state, :phone, :best_contact, presence: true
  ...
  before_validation :streetCap, :cityCap, :firstCap, :lastCap, :occCap, :emailLower, :phoneSimplify
